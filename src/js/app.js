...
(function() {
    ...
    const renderer = {
        ...
        renderAll() {
            ...
            // 更新群組顯示狀態
            elements.pendingGroup.style.display = pending.length > 0 ? 'block' : 'none';
            elements.completedGroup.style.display = completed.length > 0 ? 'block' : 'none';
    ...
    const handlers = {
        ...
        handleKeydown(e) {
            ...
            // 編輯模式中的 Escape
            if (e.key === 'Escape' && todoElement && todoElement.classList.contains('editing')) {
                renderer.exitEditMode(todoElement, todoElement.dataset.originalText);
                e.preventDefault();
            }
    ...
    function init() {
        ...
        elements.pendingList.addEventListener('click', (e) => handlers.handleListClick(e));
        elements.completedList.addEventListener('click', (e) => handlers.handleListClick(e));
